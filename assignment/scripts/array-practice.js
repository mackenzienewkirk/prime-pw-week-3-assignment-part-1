...
let favoriteFoods = ['tacos', 'mango', 'sushi'];
...
console.log('Added broccoli to the end of the favorite foods list,', favoriteFoods);
...
favoriteFoods = ['tacos', 'mango', 'sushi'];
const removed = favoriteFoods.splice(2, 1);
...
console.log('Sorted and reversed', favoriteFoods);


// 4.g (STRETCH) TODO: Convert your array to a string
//     putting the word "and" between each item.
//     eg "tacos and pizza and pasta". Log the string.
console.log( 'tacos' + ' ' + 'and' + ' '  + 'mangos' + ' ' + 'and'  + ' ' + 'sushi')
